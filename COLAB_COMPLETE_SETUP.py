# Google Colab에서 기존 리포지토리 구조로 실험하기
...
!mkdir -p isml-assignment/Char_Transformer_Language_Model
!mkdir -p isml-assignment/bpeasy
!mkdir -p isml-assignment/tiktoken
...
# 파일로 저장
with open('Char_Transformer_Language_Model/input.txt', 'w', encoding='utf-8') as f:
    f.write(sample_text)

print(f"샘플 데이터 생성 완료: {len(sample_text):,} 문자")
```
